...
if __name__ == "__main__":
    ...
    parser.add_argument('-img_size', '--target_size', type=str, default='224x224', help="Image Dimension required by the model, PLease use 299x299 for CNN-RNN Model, and 112x112 for C3D Model, 128x72 for Li3D, otherwise default is 224x224")
    ...
    parser.add_argument('-model', '--model_type', type=str, default='CollideNet', help="Type of the model: ['CNN-RNN', 'C3D', 'ResNet3D', 'VGG16', 'X3D', 'ViViT', 'TimeSformer', 'VideoSwin', 'Li3D', 'HyCT', 'VideoFocalNets', 'VidNeXt', 'CollideNet']")
    parser.add_argument('-dataset', '--dataset', default='DoTA', type=str, help="Name of the Dataset: ['CCD', 'DoTA', 'DAD']")
